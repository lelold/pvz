...
func (_m *ReceptionService) CloseLastReception(pvzID string) (*model.Reception, error) {
	ret := _m.Called(pvzID)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*model.Reception, error)); ok {
		return rf(pvzID)
	}
	if rf, ok := ret.Get(0).(func(string) *model.Reception); ok {
		r0 = rf(pvzID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ReceptionService) StartReception(pvzID string) (*model.Reception, error) {
	ret := _m.Called(pvzID)
